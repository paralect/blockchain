...
contract Crowdsale {
        ...
        public
    {
        ...
        // Token price is $0.10 and %10 discount for Pre Sale
        tokensPerWei = SafeMath.mul(ethPrice, 11);  // tokensPerWei is 2200 initially
    }
    ...
    *   - Based on token price is $0.10 and %10 discount for Pre Sale
